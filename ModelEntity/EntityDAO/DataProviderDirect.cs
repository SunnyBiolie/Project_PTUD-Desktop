...
{
    public class DataProviderDirect
    {
        // Pattern Singleton
        private static DataProviderDirect instance;
        public static DataProviderDirect Instance
        {
            get
            {
                if (instance == null) instance = new DataProviderDirect();
                return DataProviderDirect.instance;
            }
            private set => DataProviderDirect.instance = value;
        }

        private DataProviderDirect() { }
